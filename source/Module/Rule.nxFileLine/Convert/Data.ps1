...
data doesNotContainPattern
{
    @{
        ...
        'ClientAliveCountMax 0' = 'DynamicallyGeneratedDoesNotContainPattern'
        'Compression delayed' = 'DynamicallyGeneratedDoesNotContainPattern'
        'CREATE_HOME yes' = 'DynamicallyGeneratedDoesNotContainPattern'
        ...
        'GSSAPIAuthentication no' = 'DynamicallyGeneratedDoesNotContainPattern'
        'HostbasedAuthentication no' = 'DynamicallyGeneratedDoesNotContainPattern'
        'idle-activation-enabled=true' = 'DynamicallyGeneratedDoesNotContainPattern'
        'IgnoreRhosts yes' = 'DynamicallyGeneratedDoesNotContainPattern'
        'IgnoreUserKnownHosts yes' = 'DynamicallyGeneratedDoesNotContainPattern'
        'INACTIVE=0' = 'DynamicallyGeneratedDoesNotContainPattern'
        'KerberosAuthentication no' = 'DynamicallyGeneratedDoesNotContainPattern'
        ...
        'name_format = hostname' = 'DynamicallyGeneratedDoesNotContainPattern'
        'network_failure_action = syslog' = 'DynamicallyGeneratedDoesNotContainPattern'
        'overflow_action = syslog' = 'DynamicallyGeneratedDoesNotContainPattern'
        'password substack system-auth' = 'DynamicallyGeneratedDoesNotContainPattern'
        'path = /sbin/audisp-remote' = 'DynamicallyGeneratedDoesNotContainPattern'
        'PermitRootLogin no' = 'DynamicallyGeneratedDoesNotContainPattern'
        'PrintLastLog yes' = 'DynamicallyGeneratedDoesNotContainPattern'
        'remote_server = 10.0.21.1' = 'DynamicallyGeneratedDoesNotContainPattern'
        'RhostsRSAAuthentication no' = 'DynamicallyGeneratedDoesNotContainPattern'
        'SELINUXTYPE = targeted' = 'DynamicallyGeneratedDoesNotContainPattern'
        'server_args = -s /var/lib/tftpboot' = 'DynamicallyGeneratedDoesNotContainPattern'
        'space_left = 225' = 'DynamicallyGeneratedDoesNotContainPattern'
        'space_left_action = email' = 'DynamicallyGeneratedDoesNotContainPattern'
        'StrictModes yes' = 'DynamicallyGeneratedDoesNotContainPattern'
        ...
        'UsePrivilegeSeparation sandbox' = 'DynamicallyGeneratedDoesNotContainPattern'
        ...
        'X11Forwarding yes' = 'DynamicallyGeneratedDoesNotContainPattern'
    }
}
