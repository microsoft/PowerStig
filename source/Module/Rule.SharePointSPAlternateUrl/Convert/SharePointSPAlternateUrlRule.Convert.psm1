...
using module .\..\SharePointSPAlternateUrlRule.psm1
...
#>
class SharePointSPAlternateUrlRuleConvert : SharePointSPAlternateUrlRule
{
    <#
        .SYNOPSIS
            Empty constructor for SplitFactory
    #>
    SharePointSPAlternateUrlRuleConvert ()
    {
    }
    ...
    #>
    SharePointSPAlternateUrlRuleConvert ([xml.xmlelement] $XccdfRule) : base ($XccdfRule, $true)
    {
