...
Describe 'Backup-StigSettings' {
    ...
    It 'Should not throw WindowsServer' {
        { Backup-StigSettings -StigName "WindowsServer-2022-MS-2.6.xml" } | Should -not -Throw
    }

    It 'Should not throw WindowsClient' {
        { Backup-StigSettings -StigName "WindowsClient-10-3.5.xml" } | Should -not -Throw
    }

    It 'Should not throw Sql Server 2016' {
        { Backup-StigSettings -StigName "SqlServer-2016-Instance-3.5.xml" } | Should -not -Throw
    }
...
Describe 'Restore-StigSettings' {
    ...
    It 'Should not throw for Server' {
        { Restore-StigSettings -StigName "WindowsServer-2022-MS-2.6.xml" -Confirm:$false } | Should -Not -Throw
    }

    It 'Should not throw for Client' {
        { Restore-StigSettings -StigName "WindowsClient-10-3.5.xml" -Confirm:$false } | Should -Not -Throw
    }

    It 'Should not throw for Sql Server 2016' {
        { Restore-StigSettings -StigName "SqlServer-2016-Instance-3.5.xml" -Confirm:$false } | Should -Not -Throw
    }
