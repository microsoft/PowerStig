...
Describe 'Backup-StigSettings' {
    ...
    It 'Should not throw WindowsServer' {
        { Backup-StigSettings -StigName "WindowsServer-2019-MS-3.7.xml" } | Should -not -Throw
    }

    It 'Should not throw WindowsClient' {
        { Backup-StigSettings -StigName "WindowsClient-10-3.6.xml" } | Should -not -Throw
    }

    It 'Should not throw Sql Server 2016' {
        { Backup-StigSettings -StigName "SqlServer-2016-Instance-3.6.xml" } | Should -not -Throw
    }
