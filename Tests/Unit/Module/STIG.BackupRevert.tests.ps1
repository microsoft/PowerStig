...
Describe 'Backup-StigSettings' {
    ...
    It 'Should not throw Sql Server 2016' {
        {Backup-StigSettings -StigName "SqlServer-2016-Instance-2.11.xml"} | Should -not -Throw
    }
...
Describe 'Restore-StigSettings' {
    ...
    It 'Should not throw for Sql Server 2016' {
        {Restore-StigSettings -StigName "SqlServer-2016-Instance-2.11.xml" -Confirm:$false} | Should -Not -Throw
    }
