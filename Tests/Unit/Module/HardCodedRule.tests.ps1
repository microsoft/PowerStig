...
$setDynamicClassFileParams = @{
    ClassModuleFileName = 'ConvertFactory.psm1', 'HardCodedRule.Convert.psm1'
    PowerStigBuildPath  = $script:moduleRoot
    DestinationPath     = (Join-Path -Path $PSScriptRoot -ChildPath '..\.DynamicClassImport\HardCodedRule.Convert.ps1')
}
