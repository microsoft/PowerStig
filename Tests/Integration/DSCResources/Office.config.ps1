configuration Office_config
{
    ...
    Node localhost
    {
        ...
        $psboundParams.OfficeApp = $psboundParams['TechnologyVersion']
        ...
        $resourceScriptBlockString = New-ResourceString -ResourceParameterString $resourceParamString -ResourceName Office
